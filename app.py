...
"""Función para la pagina de Productos"""
...
def updateProduct(name):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            updateProductInMovements(old_price, request.form['product_price'])
            return redirect("/products/")
...
"""Función para la página de Reporte de Balance de Productos"""
